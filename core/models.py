...
class Member(models.Model):
    ...
    phone_private = models.CharField('Tel. Privé', max_length=32, blank=True, null=True)

    phone_mobile  = models.CharField('GSM', max_length=32, blank=True, null=True)

    phone_work    = models.CharField('Tel. Werk', max_length=32, blank=True, null=True)

    external_id = models.CharField(max_length=50, blank=True, null=True, db_index=True)

    # voor investeringsbijdrage
    investment_years_total = models.PositiveIntegerField(default=0)
    investment_years_remaining = models.PositiveIntegerField(default=0)

    # voor flex
    flex_years_total = models.PositiveIntegerField(default=7)
    flex_years_remaining = models.PositiveIntegerField(default=0)
...
class YearRule(_models.Model):
    ...
    class Meta:
        verbose_name = _("Jaarregel")
        verbose_name_plural = _("Jaarregels")
